...
_OPTIONAL_KEYS = ["energy", "forces", "stress", "dataset", "eat_weights", "enable_eat_grad"]  # add eat_weights and enable_eat_grad as optional key    # -------------------- EAT MODIFICATION --------------------
...
class AtomicData:
    def __init__(
        ...
        # Assign eat_weights to AtomicData object                               # -------------------- EAT MODIFICATION --------------------
        if eat_weights is not None:                                             # -------------------- EAT MODIFICATION --------------------
            self.eat_weights = eat_weights                                      # -------------------- EAT MODIFICATION --------------------
        self.enable_eat_grad = enable_eat_grad                                   # -------------------- EAT MODIFICATION --------------------
    ...
    def validate(self):
        ...
        # make sure eat_weights has compatible dims                                                             # -------------------- EAT MODIFICATION --------------------
    ...
    def from_ase(
        ...
        # EAT weights, if present                                                           # -------------------- EAT MODIFICATION --------------------
        eat_weights = None                                                                  # -------------------- EAT MODIFICATION --------------------
        if "eat_weights" in atoms.arrays:                                                   # -------------------- EAT MODIFICATION --------------------
            eat_np = np.array(atoms.arrays["eat_weights"], copy=True)                       # -------------------- EAT MODIFICATION --------------------
            # expect shape (natoms, max_num_elements) or (natoms, n_basis)                  # -------------------- EAT MODIFICATION --------------------
            eat_weights = torch.tensor(                                                     # -------------------- EAT MODIFICATION --------------------
                eat_np,                                                                     # -------------------- EAT MODIFICATION --------------------
                dtype=target_dtype,                                                         # -------------------- EAT MODIFICATION --------------------
                requires_grad=True,                                                         # -------------------- EAT MODIFICATION --------------------
            )                                                                               # -------------------- EAT MODIFICATION --------------------
        enable_eat_grad = bool(atoms.info.get("enable_eat_grad", False))                    # -------------------- EAT MODIFICATION --------------------
